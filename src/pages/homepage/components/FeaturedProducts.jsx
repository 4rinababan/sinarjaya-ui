...
const FeaturedProducts = () => {
  ...
  const featuredProducts = [
    {
      id: 1,
      name: "Jendela Aluminium Minimalis",
      category: "Jendela Aluminium Minimalis",
      price: "Rp 85.000",
    ...
    {
      id: 2,
      name: "Pintu Sliding Minimalis",
      category: "Pintu Minimalis",
      price: "Rp 1.250.000",
    ...
    {
      id: 3,
      name: "Partisi Kaca Aluminium Minimalis",
      category: "Partisi Aluminum",
      price: "Rp 2.850.000",
      originalPrice: null,
